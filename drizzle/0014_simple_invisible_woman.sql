...
INSERT INTO `__new_user_permissions`("id", "user_id", "permission_id", "status", "scope", "created_by", "updated_by", "created_at", "updated_at") SELECT "id", "user_id", "permission_id", "status", "scope", "created_by", "updated_by", "created_at", "updated_at" FROM `user_permissions`;--> statement-breakpoint
